...
import { appendYaml, FRONTMATTER_KEY, sanitizeProjectDescription, stripAutoGeneratedContent, TASK_FRONTMATTER_KEY } from './YamlParser'
...
export function serializeProject(project: Project, statuses: StatusConfig[] = []): string {
  ...
  const description = sanitizeProjectDescription(project.description)
