...
import { CUSTOM_FIELD_TYPES, makeTask, PRIORITY_ICON_SETS } from '../types'
import { stripAutoGeneratedContent, sanitizeProjectDescription } from './YamlParser'
...
export function hydrateProjectFromFrontmatter(
  ...
  return {
    ...
    description: typeof frontmatter.description === 'string' ? sanitizeProjectDescription(frontmatter.description) : '',
